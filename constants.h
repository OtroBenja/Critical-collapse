...
#define SAVE_RES 4
#define SAVE_ITERATION 200
#define FIRST_ITERATION 8000 //77950
#define MIN_R 48
#define MAX_R 50
#define ITERATIONS 10000
#define EPSILON 0 // Default Kreiss-Oliger dampening
#define BETA 0.0
...
#define OVERLAP 20 // Amount of overlapping points between subgrids (min 1)
#define EXTRA_N (1+GRID_RATIO*(OVERLAP-1)) // Amount of extra points for overlapping subgrids